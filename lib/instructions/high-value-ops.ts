...
- Any operation (transfer, payout, purchase, contract change) worth $1,000 or more always requires human approval, with no exceptions and no auto-approval path.
